/* hash_table.h - 哈希表头文件：定义数据结构和函数接口 */
/* 这个头文件定义了哈希表的数据结构和相关函数的接口，供 main.c 和 hash_table.c 使用。它包含了哈希表的基本操作，如创建、插入、导出和销毁。 */
#ifndef HASH_TABLE_H
#define HASH_TABLE_H

/* ==============================================================
 * hash_table.h — 哈希表数据结构声明
 * [v1.0 原版] [v1.1 完全复用，未修改]
 * ============================================================== */
